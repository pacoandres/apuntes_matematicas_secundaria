...
\usepackage{hyperref} %Para que no chille con otro paquete que no sé cual es.
...
\end{itemize}
\section{Transformaciones de productos en sumas.}
\begin{itemize}
\item $\cos x \cos y = \frac{\cos (x+y) + \cos (x-y)}{2}$
\item $\sen x \sen y = \frac{\cos (x-y) - \cos (x+y)}{2}$
\item $\sen x \cos y = \frac{\sen (x+y) + \sen (x-y)}{2}$
\item $\cos x \sen y = \frac{\sen (x+y) - \sen (x-y)}{2}$
\end{itemize}
